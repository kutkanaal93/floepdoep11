...
def graphql(query, variables=None, attempts=3):
    ...
    headers = {
        ...
        "User-Agent": "SorareKeeperMarketWatch/2.2",
    }
...
def main():
    ...
    print("=== SORARE KEEPER BOT v2.2 — ALL PUBLIC MARKET TRANSACTIONS ===", flush=True)
    print(
    ...
    print(
        f"Market triggers (ALLE publieke transacties samen): {BUY_SPIKE_COUNT}+ buys/{BUY_SPIKE_MINUTES}m | "
